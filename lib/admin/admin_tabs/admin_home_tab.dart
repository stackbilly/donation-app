...
class CharityApplicantsPage extends StatefulWidget {
  const CharityApplicantsPage({super.key, required this.theme});

  final bool theme;
  @override
  State<CharityApplicantsPage> createState() => _CharityApplicantsPageState();
}

class _CharityApplicantsPageState extends State<CharityApplicantsPage> {
  final Stream<QuerySnapshot> applicants =
      FirebaseFirestore.instance.collection('charityapplicants').snapshots();
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Charity Applicants'),
          leading: InkWell(
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      child: Text(
                          data.docs[index]['name'].toString()[0].toUpperCase()),
                    ),
                    title: Text(
                      '${data.docs[index]['name']},\nTel ${data.docs[index]['phone']}',
                      style: const TextStyle(
                        fontWeight: FontWeight.w500,
                      ),
                    ),
